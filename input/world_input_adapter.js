...
WorldInputAdapter.prototype.isMouseButtonDown = function(mouseButton) {
  return ContainerManager.getInstance().isMouseButtonDown(keycode);
};
...
WorldInputAdapter.prototype.getMovementX = function(e) {
...
WorldInputAdapter.prototype.getMovementY = function(e) {
